...
type User struct {
	...
	LangCode          string `json:"language_code"`               // Optional. IETF language tag of the user's language
	CanJoinGroups     bool   `json:"can_join_groups"`             // Optional. True, if the bot can be invited to groups. Returned only in getMe.
	CanReadGroupsMsgs bool   `json:"can_read_all_group_messages"` // Optional. True, if privacy mode is disabled for the bot. Returned only in getMe.
	IsInlineQueries   bool   `json:"supports_inline_queries"`     // Optional. True, if the bot supports inline queries. Returned only in getMe.
}
...
type ChatPhoto struct {
	SmallID     string `json:"small_file_id"`        // File identifier of small (160x160) chat photo. This file_id can be used only for photo download and only for as long as the photo is not changed.
	SmallIDUniq string `json:"small_file_unique_id"` // Unique file identifier of small (160x160) chat photo, which is supposed to be the same over time and for different bots. Can't be used to download or reuse the file.
	BigID       string `json:"big_file_id"`          // File identifier of big (640x640) chat photo. This file_id can be used only for photo download and only for as long as the photo is not changed.
	BigIDUniq   string `json:"big_file_unique_id"`   // Unique file identifier of big (640x640) chat photo, which is supposed to be the same over time and for different bots. Can't be used to download or reuse the file.
}

// ChatPermissions Describes actions that a non-administrator user is allowed to take in a chat.
type ChatPermissions struct {
	CanSendMsg           bool `json:"can_send_messages"`         // Optional. True, if the user is allowed to send text messages, contacts, locations and venues
	CanSendMediaMsg      bool `json:"can_send_media_messages"`   // Optional. True, if the user is allowed to send audios, documents, photos, videos, video notes and voice notes, implies can_send_messages
	CanSendPolls         bool `json:"can_send_polls"`            // Optional. True, if the user is allowed to send polls, implies can_send_messages
	CanSendOtherMsgs     bool `json:"can_send_other_messages"`   // Optional. True, if the user is allowed to send animations, games, stickers and use inline bots, implies can_send_media_messages
	CanAddWebPagePrewiew bool `json:"can_add_web_page_previews"` // Optional. True, if the user is allowed to add web page previews to their messages, implies can_send_media_messages
	...
	CanPinMsgs           bool `json:"can_pin_messages"`          // Optional. True, if the user is allowed to pin messages. Ignored in public supergroups
}

// ChatLocation Represents a location to which a chat is connected.
type ChatLocation struct {
	Loc  Location `json:"location"` // The location to which the supergroup is connected. Can't be a live location.
	Addr string   `json:"address"`  // Location address; 1-64 characters, as defined by the chat owner
}

// ChatMember This object contains information about one member of a chat.
type ChatMember struct {
	Usr               User   `json:"user"`                      // Information about the user
	Status            string `json:"status"`                    // The member's status in the chat. Can be “creator”, “administrator”, “member”, “restricted”, “left” or “kicked”
	CustomTitle       string `json:"custom_title"`              // Optional. Owner and administrators only. Custom title for this user
	IsAnonymous       bool   `json:"is_anonymous"`              // Optional. Owner and administrators only. True, if the user's presence in the chat is hidden
	...
	CanPostMsg        bool   `json:"can_post_messages"`         // Optional. Administrators only. True, if the administrator can post in the channel; channels only
	CanEditMsg        bool   `json:"can_edit_messages"`         // Optional. Administrators only. True, if the administrator can edit messages of other users and can pin messages; channels only
	CanDeleteMsg      bool   `json:"can_delete_messages"`       // Optional. Administrators only. True, if the administrator can delete messages of other users
	CanRestrictMsg    bool   `json:"can_restrict_members"`      // Optional. Administrators only. True, if the administrator can restrict, ban or unban chat members
	CanPromoteMembers bool   `json:"can_promote_members"`       // Optional. Administrators only. True, if the administrator can add new administrators with a subset of their own privileges or demote administrators that he has promoted, directly or indirectly (promoted by administrators that were appointed by the user)
	CanChangeInfo     bool   `json:"can_change_info"`           // Optional. Administrators and restricted only. True, if the user is allowed to change the chat title, photo and other settings
	CanInviteUsers    bool   `json:"can_invite_users"`          // Optional. Administrators and restricted only. True, if the user is allowed to invite new users to the chat
	CanPinMsg         bool   `json:"can_pin_messages"`          // Optional. Administrators and restricted only. True, if the user is allowed to pin messages; groups and supergroups only
	IsMember          bool   `json:"is_member"`                 // Optional. Restricted only. True, if the user is a member of the chat at the moment of the request
	CanSendMsg        bool   `json:"can_send_messages"`         // Optional. Restricted only. True, if the user is allowed to send text messages, contacts, locations and venues
	CanSendMedia      bool   `json:"can_send_media_messages"`   // Optional. Restricted only. True, if the user is allowed to send audios, documents, photos, videos, video notes and voice notes
	CanSendPolls      bool   `json:"can_send_polls"`            // Optional. Restricted only. True, if the user is allowed to send polls
	CanSendOtherMsg   bool   `json:"can_send_other_messages"`   // Optional. Restricted only. True, if the user is allowed to send animations, games, stickers and use inline bots
	CanAddWebPagePrw  bool   `json:"can_add_web_page_previews"` // Optional. Restricted only. True, if the user is allowed to add web page previews to their messages
	UntilDate         int    `json:"until_date"`                // Optional. Restricted and kicked only. Date when restrictions will be lifted for this user; unix time
}
...
type MessageEntity struct {
	...
	Usr    User   `json:"user"`     // Optional. For “text_mention” only, the mentioned user
	Lang   string `json:"language"` // Optional. For “pre” only, the programming language of the entity text
}

// PhotoSize This object represents one size of a photo or a file / sticker thumbnail.
type PhotoSize struct {
	FileID     string `json:"file_id"`        // Identifier for this file, which can be used to download or reuse the file
	FileUniqID string `json:"file_unique_id"` // Unique identifier for this file, which is supposed to be the same over time and for different bots. Can't be used to download or reuse the file.
...
type PollAnswer struct {
	...
	Usr       User   `json:"user"`       // The user, who changed the answer to the poll
...
type Poll struct {
	...
	VoterCount    int             `json:"total_voter_count"`       // Total number of users that voted in the poll
	IsClosed      bool            `json:"is_closed"`               // True, if the poll is closed
	IsAnon        bool            `json:"is_anonymous"`            // True, if the poll is anonymous
	Type          string          `json:"type"`                    // Poll type, currently can be “regular” or “quiz”
	IsMultAnswers bool            `json:"allows_multiple_answers"` // True, if the poll allows multiple answers
	CorrecOptID   int             `json:"correct_option_id"`       // Optional. 0-based identifier of the correct answer option. Available only for polls in the quiz mode, which are closed, or was sent (not forwarded) by the bot or to the private chat with the bot.
	...
	ExplEntities  []MessageEntity `json:"explanation_entities"`    // Optional. Special entities like usernames, URLs, bot commands, etc. that appear in the explanation
...
type Location struct {
	...
	HorizontalAcc float64 `json:"horizontal_accuracy"`    // Optional. The radius of uncertainty for the location, measured in meters; 0-1500
	...
	AlertRadius   int     `json:"proximity_alert_radius"` // Optional. Maximum distance for proximity alerts about approaching another chat member, in meters. For sent live locations only.
}

// Venue This object represents a venue.
type Venue struct {
	Loc             Location `json:"location"`          // Venue location. Can't be a live location
	...
	GooglePlaceType string   `json:"google_place_type"` // Optional. Google Places type of the venue. (See: https://developers.google.com/places/web-service/supported_types)
}
...
type KeyboardButton struct {
	...
	RequestPool     KeyboardButtonPollType `json:"request_poll"`     // Optional. If specified, the user will be asked to create a poll and send it to the bot when the button is pressed. Available in private chats only
}
...
type LoginURL struct {
	...
	ReqWriteAccess bool   `json:"request_write_access"` // Optional. Pass True to request the permission for your bot to send messages to the user.
}
...
type InlineKeyboardButton struct {
	...
	SwitchInlineChat string `json:"switch_inline_query_current_chat"` // Optional. If set, pressing the button will insert the bot's username and the specified inline query in the current chat's input field. Can be empty, in which case only the bot's username will be inserted.
...
type CallbackQuery struct {
	...
	Msg           Message `json:"message"`           // Optional. Message with the callback button that originated the query. Note that message content and message date will not be available if the message is too old
	InlineMsg     string  `json:"inline_message_id"` // Optional. Identifier of the message sent via the bot in inline mode, that originated the query.
...
type InputMediaPhoto struct {
	...
	ParseMode       string          `json:"parse_mode"`       // Optional. Mode for parsing entities in the photo caption. See formatting options for more details. (https://core.telegram.org/bots/api#formatting-options)
...
type InputMediaVideo struct {
	...
	SupportStreaming bool            `json:"supports_streaming"` // Optional. Pass True, if the uploaded video is suitable for streaming
}
...
// MessageSendType SendMessageType
type MessageSendType struct {
	...
	ParseMode             string        `json:"parse_mode"`                  // Optional. Mode for parsing entities in the message text. See https://core.telegram.org/bots/api#formatting-options for more details.
	...
	DisableWebPagePrewiew bool          `json:"disable_web_page_preview"`    // Optional. Disables link previews for links in this message
	...
	ReplyToMsg            int           `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowWithoutReply     bool          `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup           interface{}   `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
}
...
type ForwardMessageType struct {
	...
	ForwardChatID       interface{} `json:"from_chat_id"`         // Unique identifier for the chat where the original message was sent (or channel username in the format @channelusername)
	DisableNotification bool        `json:"disable_notification"` // Optional. Sends the message silently. Users will receive a notification with no sound.
...
type CopyMessageType struct {
	...
	MessageID                int             `json:"message_id"`                  // Message identifier in the chat specified in from_chat_id
	Caption                  string          `json:"caption"`                     // Optional. New caption for media, 0-1024 characters after entities parsing. If not specified, the original caption is kept
	ParseMode                string          `json:"parse_mode"`                  // Optional. Mode for parsing entities in the document caption. See formatting options for more details.
	CaptionEntities          []MessageEntity `json:"caption_entities"`            // Optional. List of special entities that appear in the new caption, which can be specified instead of parse_mode
	DisableNotification      bool            `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int             `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply bool            `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup              interface{}     `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
}
...
type SendPhotoType struct {
	...
	Caption                  string          `json:"caption"`                     // Optional. Photo caption (may also be used when resending photos by file_id), 0-1024 characters after entities parsing
...
type SendAudioType struct {
	...
	Audio           interface{}     `json:"audio"`            // Audio file to send. Pass a file_id as String to send an audio file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an audio file from the Internet, or upload a new one using multipart/form-data.
	Caption         string          `json:"caption"`          // Optional. Photo caption (may also be used when resending photos by file_id), 0-1024 characters after entities parsing
	ParseMode       string          `json:"parse_mode"`       // Optional. Mode for parsing entities in the audio caption. See formatting options for more details.
	CaptionEntities []MessageEntity `json:"caption_entities"` // Optional. List of special entities that appear in the caption, which can be specified instead of parse_mode
	Duration        int             `json:"duration"`         // Optional. Duration of the audio in seconds
	...
	Thumb                    interface{} `json:"thumb"`                       // Optional. Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>
	DisableNotification      bool        `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int         `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply bool        `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup              interface{} `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
...
type SendDocumentType struct {
	...
	Document interface{} `json:"document"` // File to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data.
	// Thumb string(fileID) InputFile type
	Thumb                       interface{}     `json:"thumb"`                          // Optional. Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>
	Caption                     string          `json:"caption"`                        // Optional. Document caption (may also be used when resending photos by file_id), 0-1024 characters after entities parsing
	ParseMode                   string          `json:"parse_mode"`                     // Optional. Mode for parsing entities in the document caption. See formatting options for more details.
	CaptionEntities             []MessageEntity `json:"caption_entities"`               // Optional. List of special entities that appear in the caption, which can be specified instead of parse_mode
	DisableContentTypeDetection bool            `json:"disable_content_type_detection"` // Optional. Disables automatic server-side content type detection for files uploaded using multipart/form-data
	DisableNotification         bool            `json:"disable_notification"`           // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID            int             `json:"reply_to_message_id"`            // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply    bool            `json:"allow_sending_without_reply"`    // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup                 interface{}     `json:"reply_markup"`                   // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
...
type SendVideoType struct {
	...
	Video    interface{} `json:"video"`    // Video to send. Pass a file_id as String to send a video that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the Internet, or upload a new video using multipart/form-data.
	Duration int         `json:"duration"` // Optional. Duration of sent video in seconds
	Width    int         `json:"width"`    // Optional. Video width
	Height   int         `json:"height"`   // Optional. Video height
	// Thumb string(fileID) InputFile type
	Thumb                    interface{}     `json:"thumb"`                       // Optional. Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>
	Caption                  string          `json:"caption"`                     // Optional. Video caption (may also be used when resending videos by file_id), 0-1024 characters after entities parsing
	ParseMode                string          `json:"parse_mode"`                  // Optional. Mode for parsing entities in the video caption. See formatting options for more details.
	CaptionEntities          []MessageEntity `json:"caption_entities"`            // Optional. List of special entities that appear in the caption, which can be specified instead of parse_mode
...
type SendAnimationType struct {
	...
	Animation interface{} `json:"animation"` // Animation to send. Pass a file_id as String to send an animation that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an animation from the Internet, or upload a new animation using multipart/form-data.
	Duration  int         `json:"duration"`  // Optional. Duration of sent video in seconds
	Width     int         `json:"width"`     // Optional. Video width
	Height    int         `json:"height"`    // Optional. Video height
	// Thumb string(fileID) InputFile type
	Thumb                    interface{}     `json:"thumb"`                       // Optional. Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>
	Caption                  string          `json:"caption"`                     // Optional. Animation caption (may also be used when resending animations by file_id), 0-1024 characters after entities parsing
	ParseMode                string          `json:"parse_mode"`                  // Optional. Mode for parsing entities in the animation caption. See formatting options for more details.
	CaptionEntities          []MessageEntity `json:"caption_entities"`            // Optional. List of special entities that appear in the caption, which can be specified instead of parse_mode
	DisableNotification      bool            `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int             `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
...
type SendVoiceType struct {
	...
	Voice                    interface{}     `json:"voice"`                       // Audio file to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data.
	Caption                  string          `json:"caption"`                     // Optional. Voice message caption, 0-1024 characters after entities parsing
...
type SendVideoNoteType struct {
	...
	Duration  int         `json:"duration"`   // Optional. Duration of sent video in seconds
	Length    int         `json:"length"`     // Optional. Video width and height, i.e. diameter of the video message
	// Thumb string(fileID) InputFile type
	Thumb                    interface{} `json:"thumb"`                       // Optional. Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>
	DisableNotification      bool        `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int         `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
...
type SendLocationType struct {
	...
	HorizontalAcc            float64     `json:"horizontal_accuracy"`         // Optional. The radius of uncertainty for the location, measured in meters; 0-1500
	LivePeriod               int         `json:"live_period"`                 // Optional. Period in seconds for which the location will be updated (see Live Locations, should be between 60 and 86400.
...
type EditMessageLiveLocationType struct {
	// ChatID string or int
	ChatID               interface{} `json:"chat_id"`                // Optional. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	MessageID            int         `json:"message_id"`             // Optional. Required if inline_message_id is not specified. Identifier of the message to edit
	InlineMessageID      string      `json:"inline_message_id"`      // Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
	Latitude             float64     `json:"latitude"`               // Latitude of the location
	Longitude            float64     `json:"longitude"`              // Longitude of the location
	HorizontalAcc        float64     `json:"horizontal_accuracy"`    // Optional. The radius of uncertainty for the location, measured in meters; 0-1500
	Heading              int         `json:"heading"`                // Optional. For live locations, a direction in which the user is moving, in degrees. Must be between 1 and 360 if specified.
	ProximityAlertRadius int         `json:"proximity_alert_radius"` // For live locations, a maximum distance for proximity alerts about approaching another chat member, in meters. Must be between 1 and 100000 if specified.
	ReplyMarkup          interface{} `json:"reply_markup"`           // Optional. A JSON-serialized object for a new inline keyboard.
}
...
type StopMessageLiveLocationType struct {
	...
	ReplyMarkup     interface{} `json:"reply_markup"`      // A JSON-serialized object for a new inline keyboard.
}
...
type SendVenue struct {
	...
	GooglePlaceID            string      `json:"google_place_id"`             // Optional. Google Places identifier of the venue
	GooglePlaceType          string      `json:"google_place_type"`           // Google Places type of the venue.
	DisableNotification      bool        `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int         `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply bool        `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup              interface{} `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
...
type SendPollType struct {
	...
	IsAnonymous              bool            `json:"is_anonymous"`                // Optional 	True, if the poll needs to be anonymous, defaults to True
	Type                     string          `json:"type"`                        // Optional 	Poll type, “quiz” or “regular”, defaults to “regular”
	AllowMultipleAnswers     bool            `json:"allows_multiple_answers"`     // Optional 	True, if the poll allows multiple answers, ignored for polls in quiz mode, defaults to False
	CorrecOptID              int             `json:"correct_option_id"`           // Optional 	0-based identifier of the correct answer option, required for polls in quiz mode
	Explanation              string          `json:"explanation"`                 // Optional 	Text that is shown when a user chooses an incorrect answer or taps on the lamp icon in a quiz-style poll, 0-200 characters with at most 2 line feeds after entities parsing
	ExplanationParseMode     string          `json:"explanation_parse_mode"`      // Optional 	Mode for parsing entities in the explanation. See formatting options for more details.
	ExplanationEntities      []MessageEntity `json:"explanation_entities"`        // Optional 	List of special entities that appear in the poll explanation, which can be specified instead of parse_mode
	OpenPeriod               int             `json:"open_period"`                 // Optional 	Amount of time in seconds the poll will be active after creation, 5-600. Can't be used together with close_date.
	CloseDate                int             `json:"close_date"`                  // Optional 	Point in time (Unix timestamp) when the poll will be automatically closed. Must be at least 5 and no more than 600 seconds in the future. Can't be used together with open_period.
	IsClosed                 bool            `json:"is_closed"`                   // Optional 	Pass True, if the poll needs to be immediately closed. This can be useful for poll preview.
	DisableNotification      bool            `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int             `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply bool            `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup              interface{}     `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
...
type SendDiceType struct {
	// ChatID string or int
	ChatID                   interface{} `json:"chat_id"`                     // Optional. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Emoji                    string      `json:"emoji"`                       // Optional 	Emoji on which the dice throw animation is based. Currently, must be one of “🎲”, “🎯”, “🏀”, “⚽”, or “🎰”. Dice can have values 1-6 for “🎲” and “🎯”, values 1-5 for “🏀” and “⚽”, and values 1-64 for “🎰”. Defaults to “🎲”
	DisableNotification      bool        `json:"disable_notification"`        // Optional. Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID         int         `json:"reply_to_message_id"`         // Optional. If the message is a reply, ID of the original message
	AllowSendingWithoutReply bool        `json:"allow_sending_without_reply"` // Optional. Pass True, if the message should be sent even if the specified replied-to message is not found
	ReplyMarkup              interface{} `json:"reply_markup"`                // Optional. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user. InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply types can be used
...
type GetUserProfilePhotos struct {
	...
	Offset int `json:"offset"`  // Optional 	Sequential number of the first photo to be returned. By default, all photos are returned.
	Limit  int `json:"limit"`   // Optional 	Limits the number of photos to be retrieved. Values between 1-100 are accepted. Defaults to 100.
}
...
type KickChatMemberType struct {
	...
	UserID    int         `json:"user_id"`    // Unique identifier of the target user
	UntilDate int         `json:"until_date"` // Optional 	Date when the user will be unbanned, unix time. If user is banned for more than 366 days or less than 30 seconds from the current time they are considered to be banned forever. Applied for supergroups and channels only.
}
...
type UnbanChatMemberType struct {
	...
	ChatID   interface{} `json:"chat_id"`        // Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
	UserID   int         `json:"user_id"`        // Unique identifier of the target user
	IfBanned bool        `json:"only_if_banned"` // Optional 	Do nothing if the user is not banned
}
...
type RestrictChatMemberType struct {
	...
	UntilDate   int             `json:"until_date"`  //  	Optional 	Date when restrictions will be lifted for the user, unix time. If user is restricted for more than 366 days or less than 30 seconds from the current time, they are considered to be restricted forever
}
...
type PromoteChatMemberType struct {
	...
	ChatID             interface{} `json:"chat_id"`              // Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
	UserID             int         `json:"user_id"`              // Unique identifier of the target user
	IsAnonymous        bool        `json:"is_anonymous"`         // Optional. Pass True, if the administrator's presence in the chat is hidden
	CanChangeInfo      bool        `json:"can_change_info"`      // Optional. Pass True, if the administrator can change chat title, photo and other settings
	CanPostMsg         bool        `json:"can_post_messages"`    // Optional 	Pass True, if the administrator can create channel posts, channels only
	CanEditMsg         bool        `json:"can_edit_messages"`    // Optional 	Pass True, if the administrator can edit messages of other users and can pin messages, channels only
	CanDeleteMsg       bool        `json:"can_delete_messages"`  // Optional 	Pass True, if the administrator can delete messages of other users
	CanInviteUsers     bool        `json:"can_invite_users"`     // Optional 	Pass True, if the administrator can invite new users to the chat
	CanRestrictMembers bool        `json:"can_restrict_members"` // Optional 	Pass True, if the administrator can restrict, ban or unban chat members
	CanPinMsg          bool        `json:"can_pin_messages"`     // Optional 	Pass True, if the administrator can pin messages, supergroups only
	CanPromoteMembers  bool        `json:"can_promote_members"`  // Optional 	Pass True, if the administrator can add new administrators with a subset of their own privileges or demote administrators that he has promoted, directly or indirectly (promoted by administrators that were appointed by him)
}
...
type SetChatPermissionsType struct {
	// ChatID string or int
	ChatID     interface{}     `json:"chat_id"`     // Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
	Permission ChatPermissions `json:"permissions"` // New default chat permissions
}
...
type SetChatDescriptionType struct {
	// ChatID string or int
	ChatID      interface{} `json:"chat_id"`     // Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
	Description string      `json:"description"` // Optional. New chat description, 0-255 characters
}
...
type PinChatMessageType struct {
	...
	DisableNotification bool        `json:"disable_notification"` // Optional. Pass True, if it is not necessary to send a notification to all chat members about the new pinned message. Notifications are always disabled in channels and private chats.
}
...
type UnpinChatMessageType struct {
	// ChatID string or int
	ChatID    interface{} `json:"chat_id"`    // Unique identifier for the target group or username of the target supergroup or channel (in the format @channelusername)
	MessageID int         `json:"message_id"` // Optional. Identifier of a message to unpin. If not specified, the most recent pinned message (by sending date) will be unpinned.
}
...
type AnswerCallbackQueryType struct {
	CallbackQuery string `json:"callback_query_id"` // Unique identifier for the query to be answered
	Text          string `json:"text"`              // Optional. Text of the notification. If not specified, nothing will be shown to the user, 0-200 characters
	ShowAlert     bool   `json:"show_alert"`        // Optional. If true, an alert will be shown by the client instead of a notification at the top of the chat screen. Defaults to false.
	URL           string `json:"url"`               // Optional. URL that will be opened by the user's client. If you have created a Game and accepted the conditions via @Botfather, specify the URL that opens your game — note that this will only work if the query comes from a callback_game button. Otherwise, you may use links like t.me/your_bot?start=XXXX that open your bot with a parameter.
	CacheTime     int    `json:"cache_time"`        // Optional. The maximum amount of time in seconds that the result of the callback query may be cached client-side. Telegram apps will support caching starting in version 3.14. Defaults to 0.
}
...
type EditMessageTextType struct {
	// ChatID string or int
	ChatID                interface{}          `json:"chat_id"`                  // Optional. Required if inline_message_id is not specified. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	MessageID             int                  `json:"message_id"`               // Optional. Required if inline_message_id is not specified. Identifier of the message to edit
	InlineMessageID       string               `json:"inline_message_id"`        // Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
	...
	Entities              []MessageEntity      `json:"entities"`                 // Optional. List of special entities that appear in message text, which can be specified instead of parse_mode
	DisableWebPagePrewiew bool                 `json:"disable_web_page_preview"` // Optional. Disables link previews for links in this message
	ReplyMarkup           InlineKeyboardMarkup `json:"reply_markup"`             // Optional. A JSON-serialized object for an inline keyboard.
}
...
type EditMessageCaptionType struct {
	...
	MessageID       int                  `json:"message_id"`        // Optional.Required if inline_message_id is not specified. Identifier of the message to edit
	InlineMessageID string               `json:"inline_message_id"` // Optional. Required if chat_id and message_id are not specified. Identifier of the inline message
	Caption         string               `json:"caption"`           // Optional. New caption of the message, 0-1024 characters after entities parsing
	ParseMode       string               `json:"parse_mode"`        // Optional. Mode for parsing entities in the message text. See formatting options for more details.
	CaptionEntities []MessageEntity      `json:""`                  // Optional. List of special entities that appear in the caption, which can be specified instead of parse_mode
	ReplyMarkup     InlineKeyboardMarkup `json:"reply_markup"`      // Optional. A JSON-serialized object for an inline keyboard.
}
